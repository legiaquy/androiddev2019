...
public class ShadowTransformerViewPager implements ViewPager.OnPageChangeListener, ViewPager.PageTransformer {
    ...
    public ShadowTransformerViewPager(ViewPager viewPager, CardAdapter adapter) {
